...
public class MaterialDialog {
    ...
    public MaterialDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        ...
        mPositiveButton.setBackgroundResource(R.drawable.md_button);
    ...
    public MaterialDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        ...
        mNegativeButton.setBackgroundResource(R.drawable.md_button);
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            View contv = LayoutInflater.from(mContext).inflate(R.layout.md_layout_materialdialog, null);
            contv.setFocusable(true);
            contv.setFocusableInTouchMode(true);

            mAlertDialogWindow.setBackgroundDrawableResource(R.drawable.md_material_dialog_window);
...
//7
        ...
        public void setPositiveButton(String text, final View.OnClickListener listener) {
            ...
            button.setBackgroundResource(R.drawable.md_material_card);
