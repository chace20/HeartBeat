...
public class PairActivity extends BaseActivity {
	...
	private void showDevicesList() {
		int dimen = ToolUtil.dip2px(this,16.0f);
		int top = ToolUtil.dip2px(this, 8.0f);
		alertBuilder = new AlertDialog.Builder(this,R.style.AlertDialogCustom)
				.setTitle("选择设备")
				.setView(devicesListView, dimen, top, dimen, dimen);
